...
\hypersetup{% Metadata adjustments, in case these are not set, the data provided for \maketitle will be used
  ...
  pdfsubject=Proactive AI moderation for goal-oriented remote meetings: Design and acceptance of a context-sensitive system to support convergent decision-making processes,
  pdftitle=Proactive AI moderation for goal-oriented remote meetings: Design and acceptance of a context-sensitive system to support convergent decision-making processes,
  pdflanguage=en,
  pdfcreationdate=\today,
  pdfkeywords={TU Darmstadt; Proactive AI moderation; Goal-oriented remote meetings; Convergent decision-making processes}
}

\title{Bachelor Thesis}

\subtitle{Proactive AI moderation for goal-oriented remote meetings: Design and acceptance of a context-sensitive system to support convergent decision-making processes}
