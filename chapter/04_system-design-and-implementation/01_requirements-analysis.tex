...
\newcommand{\acrow}[1]{%
  \multicolumn{3}{@{}p{\linewidth}@{}}{%
    \footnotesize
    \textbf{\textit{Acceptance criteria.}}
    \begin{itemize}[nosep, leftmargin=1.2em, itemsep=0.12em, label=\textendash]
        #1
\end{itemize}}}
...
\begin{xltabular}{\textwidth}{@{}
    >{\small\raggedright\arraybackslash}p{1.05cm}
    >{\small\raggedright\arraybackslash}X
    >{\small\raggedright\arraybackslash}X
  @{}}
  \caption{User stories for an AI facilitator. IDs are stable handles for later reference; each
    warrant points to the thesis section in which it is established; acceptance criteria
  operationalize the story.}
  \label{tab:ai-facilitator-user-stories}\\
  \toprule
  \textbf{ID} & \textbf{User Story} & \textbf{Reasoning} \\
  \midrule
  \endfirsthead
  ...
  \midrule
  \endhead
  \specialrule{\lightrulewidth}{0.5em}{0.2em}
  \endfoot
  \bottomrule
  \endlastfoot
