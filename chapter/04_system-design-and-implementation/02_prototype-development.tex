...
\begin{enumerate}[nosep,leftmargin=1.4em,itemsep=0.25em]
  \item exploratives Testen der system komponeten;
  \item Falls es unerwünschte Verhalten gibt, das auslösende Szenario rekonstruieren und das unerwünschte
    Verhalten eingrenzen;
  \item die tragenden Merkmale des Szenarios extrahieren;
  \item Testdaten erzeugen, typischerweise einen Dialogausschnitt;
  \item die erwartete Reaktion festlegen und gegen das Orakel prüfen;
  \item System anpassen (z.B. Architektur oder Prompts), bis das neue Verhalten eintritt, ohne bestehende
    Tests zu verletzen.
\end{enumerate}
