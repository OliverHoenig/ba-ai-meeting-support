...
facilitation may become relevant.
...
intervention/facilitation would be necessary in order to reach a well-founded group decision.
...
Hidden-profile experiments operationalize this asymmetry.
...
(\autoref{annex:davison-questionnaire}).
...
intended to place under strain. And are the same dimensions the FIM-Score are based on. (see.\ \autoref{sec:fim-score})
...
(see Questionnaire Items A1-A7 in \autoref{annex:davison-questionnaire}).
Free-text questions were appended after these items in order to collect
qualitative accounts of how participants experienced the agent's contributions
(see Questionnaire Items F1 and F2 in \autoref{annex:davison-questionnaire}).
