...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{assets/figures/prompt-chaining.png}
...
Beim Prompt Chaning wird eine komplexerer Aufgabe in eine squenzielle Abfolge von Teilschritten zerlegt.
Jeder Schritt wird durch einen Prompt und LLM-Call beschrieben, der das Ergebnis des vorherigen Schritts als
Kontext für den nächsten Schritt verwendet. Dazwischen können programatische Prüfungen eingefügt werden
(see Figure~\ref{fig:prompt-chaining}).
