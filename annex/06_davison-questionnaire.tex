...
Three additional items on the proactive AI agent were therefore appended for this
thesis, as discussed in Chapter~5.
...
\par\addvspace{0.85em}
\noindent
Die Beiträge des KI-Agenten kamen in Momenten, in denen sie den Gesprächsfluss
nicht störten, sondern unterstützten.
\hfill~(A1)\\[0.3em]
\qscale{Stimme voll zu}{Stimme überhaupt nicht zu}

\par\addvspace{0.85em}
\noindent
Der Agent schien zu verstehen, worüber wir gerade gesprochen haben.
\hfill~(A2)\\[0.3em]
\qscale{Stimme voll zu}{Stimme überhaupt nicht zu}

\par\addvspace{0.85em}
\noindent
Es war für mich angenehmer, dieses Feedback von der KI zu erhalten, als wenn
ein anderes Gruppenmitglied mich direkt darauf hingewiesen hätte.
\hfill~(A3)\\[0.3em]
\qscale{Stimme voll zu}{Stimme überhaupt nicht zu}
