...
context-sensitive AI moderation system). It does not address RQ3 (how knowledge workers
perceive a meeting with a proactive AI moderator), which is examined in a separate study.
...
muss darüber, \emph{wie es weitergeht}. Die Art der Entscheidung kann dabei sehr vielfältig sein. Typische Fälle sind
zum Beispiel:
\begin{itemize}
...
\begin{enumerate}[label=3.\arabic*, leftmargin=*]
  ...
  \item Wie stellen Sie sicher, dass den Teilnehmenden während des Meetings klar bleibt,
    ...
    \end{itemize}
  \item Wie wird sicher gestellt dass alle relevanten Informationen zur Ansprache kommen?
  \item Wie relevant ist es das alle Teilnehmen zu Wort kommen?
    \begin{itemize}[label=\textendash]
      \item \textit{Falls als relevant erachtet:} Wie stellen Sie sicher das alle Teilnehmen zu Wort kommen?
    \end{itemize}
  \item Worauf achten Sie bei der Intervention? Wei gehen Sie vor wenn Sie eingreifen?
    \begin{itemize}[label=\textendash]
      \item \textit{möchliche nachfragen:} Zu Stil (eher neutral oder eher direkt)? Bewöhrte Formulierungen?
    \end{itemize}
  \item
\end{enumerate}
  ...
  \item Welche Risiken, Schwächen oder unbeabsichtigten Wirkungen sehen Sie, wenn ein
    ...
    \begin{itemize}[label=\textendash]
      \item \textit{Falls nicht von selbst thematisiert:} Vertrauen und Kontrolle der
        ...
        Transparenz.
    \end{itemize}
  \item Welchen Einfluss hat eine persönliche Beziehung (Sympathie, Vertrauen, etc.) zwischen den
    Teilnehmenden und dem Facilitator auf die Zielorientierung und Entscheidungsgeschwindigkeit?
\end{enumerate}
