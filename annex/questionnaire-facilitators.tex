...
Verarbeitung einverstanden? [Bitte um klare Bestätigung, welche mit Aufgezeichnet wird.]
...
\begin{enumerate}[label=3.\arabic*, leftmargin=*]
  ...
  \item Worauf achten Sie, wenn sie in das Meeting z.B. in Diskussionen eingreifen? Wie gehen Sie dabei vor?
    \begin{itemize}[label=\textendash]
      \item \textit{möchliche nachfragen:} Welche Risiken gibt es wenn Sie zu früh oder zu spät eingreifen?
        Wei versuchen sie das Risiko zu veringern?
    \end{itemize}
\end{enumerate}
...
\begin{enumerate}[label=6.\arabic*, leftmargin=*]
  ...
  \item Welchen Einfluss hat eine persönliche Beziehung (Sympathie, Vertrauen, etc.) zwischen den
    Teilnehmenden und dem Facilitator auf die Zielorientierung und den Entscheidungserfolg?
\end{enumerate}
