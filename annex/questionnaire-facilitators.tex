...
--- insbesondere Formate, in denen entschieden, priorisiert oder ein Problem gelöst werden
soll --- so moderiert werden, dass die Gruppe am Ziel bleibt und zu einer Entscheidung
kommt. Aus den Gesprächen mit erfahrenen Moderatorinnen und Moderatoren leite ich ab, welche
Anforderungen ein KI-gestütztes Unterstützungssystem erfüllen müsste.
...
\begin{enumerate}[label=1.\arabic*, leftmargin=*]
  \item Bitte beschreiben Sie kurz Ihre Rolle und Ihren Erfahrungshintergrund in der
    Moderation --- insbesondere in Remote-Meetings mit konvergentem Auftrag, also dort,
    wo entschieden, priorisiert oder ein konkretes Problem gelöst werden soll.
